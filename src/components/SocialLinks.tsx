...
export default function SocialLinks({ links }: { links: TeamMember['links'] }) {
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      {links.github && (
        <a href={links.github} target="_blank" rel="noreferrer" className="text-ink-faint hover:text-brand-purple transition-colors" aria-label="GitHub">
      ...
      {links.twitter && (
        <a href={links.twitter} target="_blank" rel="noreferrer" className="text-ink-faint hover:text-brand-purple transition-colors" aria-label="Twitter">
          <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
      ...
      {links.linkedin && (
        <a href={links.linkedin} target="_blank" rel="noreferrer" className="text-ink-faint hover:text-brand-purple transition-colors" aria-label="LinkedIn">
          <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
